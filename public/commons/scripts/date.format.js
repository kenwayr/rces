...
(function () {
  ...
  var replaceChars = {
    ...
    u: function () { var H = this.getUTCHours(); return (H < 10 ? '0' : '') + H },
    q: function () { var i = this.getUTCMinutes(); return (i < 10 ? '0' : '') + i },
    z: function () { var s = this.getUTCSeconds(); return (s < 10 ? '0' : '') + s },
  }
