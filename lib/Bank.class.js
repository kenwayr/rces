...
module.exports = class Bank {
    ...
    SubmitAnswer(client, answer) {
        ...
        return {
            ...
            correctIndex: question.options.findIndex((v) => v === question.correct),
            selectedIndex: question.options.findIndex((v) => v === answer.selected)
        };
    }
    async GenerateSets() {
        var report = {
        ...
        this.clients.forEach((client, id) => {
            ...
            for(var i=0; i < groups.length; i++) {
                ...
                if(authorIndices.length === 0) {
                    ...
                    if(index === groups[i].length - 1 && authorIndices.includes(index))
