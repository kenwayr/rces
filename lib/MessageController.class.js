...
module.exports = class MessageController {
    ...
    AddDriver(driver, props) {
        var instance = new driver();
        instance.run(this, props);
    }
    ...
    static SendMessage({connection, message, template}) {
        ...
        if(template.hasOwnProperty('tag') && !finalMessage.hasOwnProperty('tag'))
    ...
    static Broadcast({list, message, template}) {
        var finalMessage = message;
        if(template.hasOwnProperty('tag') && !finalMessage.hasOwnProperty('tag'))
            finalMessage['tag'] = template.tag;
        if(template.hasOwnProperty('meta')) {
        ...
        var msg = JSON.stringify(finalMessage);
